const fs = require("fs");
const { cloudinaryServices } = require("../service/cloudinaryService");

// add image
exports.saveImageCloudinary = async (req, res, next) => {
  // console.log(req.file)
  try {
    const result = await cloudinaryServices.singleUploadImage(
      req.file.buffer
    );
    res.status(200).json({
      success: true,
...
// add image
exports.addMultipleImageCloudinary = async (req, res) => {
  try {
